...
const formatContent = (text, type = 'explanation', isRich = false, qIndex = -1, exerciseType = null) => {
  ...
  if (type === 'title' || type === 'explanation') {
    ...
    // 确保所有 <p> 标签都有闭合标签
    // 统计 <p> 和 </p> 的数量
    const openPCount = (processedHtml.match(/<p[^>]*>/gi) || []).length;
    const closePCount = (processedHtml.match(/<\/p>/gi) || []).length;
    // 如果 <p> 标签比 </p> 多，补充闭合标签
    if (openPCount > closePCount) {
      processedHtml += '</p>'.repeat(openPCount - closePCount);
    }
          ...
          <view class="practice-container">
            ...
            <view class="question-card">
                ...
                <view class="question-title-wrap">
                  ...
                  <view class="question-title-content">
                    <view class="question-title" :style="{ fontSize: dynamicFontSize.title }">
                      <!-- 使用 v-html 显示处理后的内容 -->
                      <view class="title-html-content" v-html="formatTitle(question.exercise_type === 3 ? (question.truncatedStem || question.stem) : (question.originalStem || question.stem), qIndex, question.exercise_type)"></view>
                    </view>
                  </view>
                </view>
              </view>
              ...
              <view v-if="[1, 2, 5].includes(question.exercise_type) && question.content && question.content.options" class="options-list">
                ...
                >
                  ...
                  <view class="option-content" :style="{ fontSize: dynamicFontSize.option }" v-html="formatContent(option.text || option, 'option', false, qIndex, question.exercise_type)">
                  </view>
              ...
              <view v-if="question.exercise_type === 4 || question.exercise_type_name?.includes('解答') || question.exercise_type_name?.includes('综合')" class="short-answer-section">
                ...
                <view v-if="question.subs && question.subs.length > 0" class="sub-questions">
                    ...
                    <view class="sub-stem">
                      ...
                      <view v-html="formatContent(sub.stem, 'explanation', true, qIndex, 4)"></view>
                    </view>
                    <textarea 
                    ...
                    <view v-if="shouldShowAnswer(qIndex)" class="sub-answer-section animated fadeIn">
                      <view class="sub-answer-item">
                        ...
                        <view class="value" v-html="formatContent(sub.answer || sub.originalAnswer || sub.standard_answer || sub.correct_answer, 'explanation', true, qIndex, 4)"></view>
                      </view>
                      <view class="sub-answer-item" v-if="sub.analysis || sub.commentary || sub.method || sub.explanation || sub.solution">
                        ...
                        <view class="value" v-html="formatContent(sub.analysis || sub.commentary || sub.method || sub.explanation || sub.solution, 'explanation', true, qIndex, 4)"></view>
                      </view>
                    </view>
                  </view>
                </view>
            ...
            <view v-if="shouldShowAnswer(qIndex)" class="answer-section animated fadeInUp">
              ...
              <view v-if="question.exercise_type === 3" class="explanation-card card-style">
                ...
                <view class="explanation-content" :style="{ fontSize: dynamicFontSize.explanation }" v-html="formatContent(question.displayAnswer || question.answer, 'explanation', true, qIndex, question.exercise_type)">
                </view>
              </view>
              ...
              <view v-if="(question.exercise_type === 4 || question.exercise_type_name?.includes('解答') || question.exercise_type_name?.includes('综合')) && (!question.subs || question.subs.length === 0) && question.answer" class="explanation-card card-style">
                ...
                <view class="explanation-content" :style="{ fontSize: dynamicFontSize.explanation }" v-html="formatContent(question.answer, 'explanation', true, qIndex, 4)">
                </view>
              </view>
              ...
              <view v-if="question.analysis" class="explanation-card card-style">
                ...
                <view class="explanation-content" :style="{ fontSize: dynamicFontSize.explanation }" v-html="formatExplanation(question.analysis, qIndex, question.exercise_type)">
                </view>
              </view>
                ...
                <view class="notes-list">
                  ...
                  >
                    ...
                    <view class="note-right">
                      ...
                      <view class="note-content" v-html="formatContent(note.content, 'note')">
                      </view>
                        ...
                        <view class="note-replies" v-if="note.isRepliesExpanded">
                          <view v-for="reply in note.replies" :key="reply.id" class="reply-item" @longpress="showReplyActions(reply, note)">
                            <view class="reply-content-row">
                              ...
                              <view class="reply-content" v-html="formatContent(reply.content, 'note')"></view>
                              <text 
