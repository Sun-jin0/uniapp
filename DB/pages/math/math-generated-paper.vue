  ...
  <view class="paper-container" :class="{ 'loading-mask': loading }" @click="showMoreMenu = false">
    <header class="top-bar no-print">
      <div class="top-bar-content">
        ...
        <div class="paper-title-container" @click="editTitle">
          <h1 class="paper-title">{{ paper.Title || '智能练习卷' }}</h1>
          <span class="edit-icon">✎</span>
        </div>
        <div class="top-actions" v-if="!loading">
          <!-- 更多操作菜单 -->
          <div class="more-actions-container">
            <button class="action-icon-btn more-btn" @click.stop="toggleMoreMenu">更多 ⋮</button>
            <div class="more-menu" v-if="showMoreMenu" @click.stop>
              <!-- 移动字号调节到菜单内 -->
              <div class="menu-item no-hover">
                <div class="font-ctrl-menu">
              ...
              <div class="menu-item" @click="goToAnalysis(); showMoreMenu = false">
                <span class="menu-icon">📖</span> 查看解析
              </div>
              <div class="menu-item" @click="showDataAnalysis(); showMoreMenu = false">
                <span class="menu-icon">📊</span> 数据分析
              </div>
              <div class="menu-item" @click="showPaperInfo(); showMoreMenu = false">
                <span class="menu-icon">ⓘ</span> 试卷信息
              </div>
              <div class="menu-item" @click="handlePrint(); showMoreMenu = false">
                <span class="menu-icon">⎙</span> 打印试卷
              </div>
              <div class="menu-divider"></div>
              <div class="menu-item delete" @click="confirmDelete(); showMoreMenu = false">
                <span class="menu-icon">🗑</span> 删除试卷
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="questions-list">
        <div v-for="(q, index) in paper.questions" :key="q.QuestionID" class="question-item">
          ...
          <div class="question-body">
            ...
            <!-- 考点展示 (已根据用户要求隐藏) -->
            <!-- <div class="knowledge-points-container"> ... </div> -->
          </div>
    ...
    <div class="fab-container no-print">
      <button class="fab-btn" @click="goToAnalysis">
        <span class="fab-icon">📝</span>
        <span class="fab-text">答案解析</span>
      </button>
    </div>
...
const displayMode = ref('text'); // 'image' | 'text'
...
const goBack = () => {
  ...
  if (pages.length > 1) {
    ...
    uni.redirectTo({ url: '/pages/math/math-bookshelf' });
  }
};
