  ...
  <view class="container" :class="{ 'dark-mode': isDarkMode }">
    ...
    <view class="top-data-section">
      ...
      <view class="selection-tabs-header">
        ...
        <view class="ai-qa-btn" @click="handleAICorrection">
          <SvgIcon name="edit" size="24" fill="#fff" />
          <view class="ai-text">AI作文批改</view>
  ...
  try {
    ...
    if (selectionList.value.length === 0) {
      selectionList.value = [
        ...
        { id: 3, title: '考研政治', desc: '马原/毛中特', icon: '🚩', color: '#fce4ec', url: '/pages/politics/politics-main', category: 'public' },
        { id: 4, title: '全部题库', desc: '浏览所有科目', icon: '📚', color: '#fff3e0', url: '/pages/practice/practice', isTab: true, category: 'public' },
      ];
    }
  }
};
