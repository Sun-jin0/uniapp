<template>
  <view class="container" :class="{ 'dark-mode': isDarkMode }">
    ...
    <view class="top-data-section">
      ...
      <!-- 视频资源入口 - 固定入口 -->
      <view class="video-entry-section" @click="goToVideoList">
        <view class="video-entry-card">
          <view class="video-entry-left">
            <view class="video-icon-box">
              <SvgIcon name="video" size="48" fill="#ff6b6b" />
            </view>
            <view class="video-text-content">
              <text class="video-title">视频资源</text>
              <text class="video-subtitle">考研课程、名师讲解、随时观看</text>
            </view>
          </view>
          <view class="video-entry-right">
